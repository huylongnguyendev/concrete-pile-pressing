	...
	return (
		<div className="font-semibold space-y-6">
			...
			<ul className="flex items-center gap-6">
				<li>
					<a
						href="https://facebook.com/link_cua_ban"
						target="_blank"
				...
				<li>
					<a
						href="https://zalo.me/so_dien_thoai_cua_ban"
						target="_blank"
						rel="noopener noreferrer"
					>
						<svg
